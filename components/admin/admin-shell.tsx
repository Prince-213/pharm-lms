      ...
      >
        <div className="flex h-full flex-col">
          ...
          <div className="flex h-18.5 items-center px-8">
            <Link href="/admin/dashboard" className="font-display text-xl font-bold uppercase tracking-wider text-white">
              PharmLMS
            </Link>
          </div>
          ...
          <div className="p-4 mt-auto">
            <div className="rounded-xl bg-white/5 p-4">
              <p className="text-xs font-medium text-emerald-50/40 italic text-center">Pharm LMS Admin Console</p>
            </div>
          </div>
        </div>
      </aside>
