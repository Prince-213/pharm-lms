...
const pageLinks = [
  { label: "Instructors", href: "/student/tutors" },
  { label: "Contact", href: "/contact-admin" },
            ...
            <div className="mt-5 flex items-center gap-2.5">
              {[
                ...
                <a
                  ...
                  href={href}
                  aria-label={label}
                  className="flex h-8 w-8 items-center justify-center rounded-full bg-white/10 text-white transition-colors hover:bg-[var(--accent)] hover:text-white"
                >
