...
export function FAQSection() {
  ...
  return (
    <section id="faq" className="relative bg-white py-16 lg:py-24 overflow-hidden">
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-10">
        <div className="flex flex-col lg:flex-row lg:items-start lg:gap-12 xl:gap-16">
          ...
          <div className="flex-1">
            <h2 className="mb-8 font-display text-3xl font-bold text-[var(--ink-deep)] sm:text-4xl lg:text-[2.75rem] leading-tight">
              ...
              {faqs.map((faq, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <div className="px-6 pb-6 text-[15px] leading-relaxed text-white/90">
                        {faq.answer}
                      </div>
                    </div>
                  </div>
