  ...
  return (
    <>
      ...
      <div className="mb-8 grid gap-4 sm:grid-cols-3">
        {[
          { label: "Gross revenue", value: "$0.00", sub: "Before platform fees" },
          { label: "Net to you", value: "$0.00", sub: "After fees & adjustments" },
          { label: "Avg. per learner", value: "$0.00", sub: "Trailing 30 days" },
        ].map((card) => (
          <div
            key={card.label}
          ...
          >
            ...
            <p className="mt-2 text-3xl font-bold tabular-nums text-[#1c1d1f]">{card.value}</p>
      ...
      <section className="mt-8 overflow-hidden rounded-xl border border-[#e3e5e8] bg-white shadow-sm">
        <div className="border-b border-[#ececec] px-5 py-4">
          <h2 className="text-sm font-bold text-[#1c1d1f]">Payout-ready breakdown</h2>
          <p className="text-xs text-[#6a6f73]">Placeholder rows for per-course revenue.</p>
        </div>
        <div className="overflow-x-auto">
          <table className="w-full min-w-[520px] text-left text-sm">
            ...
            <tbody>
              <tr>
                <td colSpan={4} className="px-5 py-14 text-center text-[#6a6f73]">
                  No transactions yet. Publish a priced course to populate this table.
                </td>
              </tr>
            </tbody>
          </table>
