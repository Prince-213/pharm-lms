  ...
  return (
    <div className="px-5 py-6 sm:px-8">
      <div className="mb-8 flex flex-wrap items-start justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold text-[#1c1d1f]">Announcements</h2>
          <p className="mt-1 max-w-xl text-sm text-[#6a6f73]">
      ...
      <div className="mb-10 rounded border border-[#d1d7dc] bg-[#fcfcfd] p-5 sm:p-6">
        ...
        {courses.length === 0 ? (
          <p className="rounded border border-dashed border-[#d1d7dc] bg-white p-6 text-center text-sm text-[#6a6f73]">
