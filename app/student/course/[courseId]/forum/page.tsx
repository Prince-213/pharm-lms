...
function rolePill(role: UserRole) {
  if (role === UserRole.MENTOR) return "bg-sky-50 text-sky-800 ring-sky-200";
    ...
    <div className="mx-auto max-w-5xl space-y-4">
      <div className="rounded-xl border border-[var(--border)] bg-[var(--surface)] p-5 shadow-[var(--shadow-sm)]">
        ...
        <p className="mt-2 text-sm text-[var(--muted)]">
          Ask questions, discuss lesson concepts, and share clarifications with
          your cohort and mentor.
        </p>
      </div>
        ...
        >
          <div className="flex items-end gap-3">
            <textarea
              ...
              maxLength={2000}
              required
              placeholder="Write your message to the forum..."
